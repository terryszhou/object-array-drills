...
//    variable.
var sire = album1.albumDetails.label
// console.log(sire)
...
if (band.album.length % 2 == 0) {
  console.log(`The number ${band.album.length} is even`)
} else {
  console.log(`The number ${band.album.length} is odd`)
}
...
if (band.album.length % 2 == 0 && band.album.length % 3 == 0) {
  console.log(`The number ${band.album.length} is divisible by 2 and 3`)
} else if (band.album.length % 2 == 0) {
  console.log(`The number ${band.album.length} is divisible by 2`)
} else if (band.album.length % 3 == 0) {
  console.log(`The number ${band.album.length} is divisible by 3`)
} else if (band.album.length % 3 !== 0 || band.album.length %2 !== 0) {
  console.log(`The number ${band.album.length} is not divisible by 2 and 3`)
}
...
for (i = 0; i < band.members.length; i++) {
...
let sireTally = 0
for (j = 0; j < band.album.length; j++) {
  // if (band.album[j].albumDetails.label.includes("Sire") || band.album[j].albumDetails.labels.includes("Sire")) {
  //   sireTally++
  //   console.log(band.album[j])
  //   console.log(sireTally)
  // } 
}

// let sireTally = 0
// for(let each of talkingHeadsAlbums) {
//   if(each.albumDetails.label != null && each.albumDetails.label.includes("Sire")) {
//     sireTally++
//   } else if(each.albumDetails.labels != null && each.albumDetails.labels.includes("Sire")) {
//     sireTally++
//   }
//   console.log(sireTally)
// }
